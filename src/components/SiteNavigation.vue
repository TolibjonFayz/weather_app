  ...
  <header class="sticky top-0 bg-weather-primary shadow-lg">
    ...
    >
      ...
      <div class="flex gap-3 flex-1 justify-end">
        <i
          class="fa-solid fa-circle-info text-xl hover:text-wether-secondary duration-150 cursor-pointer"
          @click="toggleModal"
        ></i>
        <i
          class="fa-solid fa-plus text-xl hover:text-wether-secondary duration-150 cursor-pointer"
          @click="addCity"
